...
case $ROLE in
    a)
        ...
        sync-folders torrent keygen "test-03-push-both-nat" > /tmp/keys.txt
...
YAML
        ...
        wait_for_dht_key "$DHT_PUB" "sync-folders:test-03-push-both-nat" 120
